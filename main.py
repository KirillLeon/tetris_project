...
# Рендер
title_tetris = main_font.render('TETRIS', True, pygame.Color('#006b52'))
title_score = font.render('score:', True, pygame.Color('#d53e07'))
title_record = font.render('record:', True, pygame.Color('#dc143c'))
